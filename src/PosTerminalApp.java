...
public class PosTerminalApp extends Inventory {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    do
	    {
            ...
            //Then firstChar is the first character of input converted to uppercase.
            ...
            if (firstChar.equals("C")){
                ...
                //later, handle if the user enters something that is not an integer and not E or C 
                ...
                //error message?
                    ...
                    //later, handle if the user enters something that is not valid
                    cart[i-1] += count;
                }
            }
